...
describe('FSHelper', function() {
    describe('listFiles', function() {
        it('should expand *', function(done) {
            ...
            .then(files => {
                expect(files).to.have.deep.members(['test/fake_project/main.cpp', 'test/fake_project/softarch.json', 'test/fake_project/package.json']);
                done();
            })
            .catch(err => {
                done(err);
        ...
        it('should expand **', function(done) {
            FSHelper.listFiles(['test/fake_project/**'])
            .then(files => {
                expect(files).to.have.deep.members(['test/fake_project/main.cpp', 'test/fake_project/package.json', 'test/fake_project/softarch.json', 'test/fake_project/assets/model.3d']);
                done();
            })
            .catch(err => {
                done(err);
    ...
    describe('walkFiles', function() {
        ...
        it('should include and exclude correctly the files', function(done) {
            ...
            .then(files => {
                expect(files).to.have.deep.members(['test/fake_project/main.cpp', 'test/fake_project/package.json', 'test/fake_project/softarch.json']);
                done();
            })
            .catch(err => {
                done(err);
